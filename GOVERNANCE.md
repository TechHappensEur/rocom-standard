...
2. **Transparent process.** All changes to normative text follow the
   Edition / Supplement / Correction Proposal process defined in
   [CONTRIBUTING.md](CONTRIBUTING.md). No changes are made outside this
   process.
